...
class TestPlace(unittest.TestCase):
    ...
    def test_max_guest_attr(self):
        """Test Place has attrbut max_guest, and it's an int == 0"""
        place = Place()
    ...
    def test_price_by_night_attr(self):
        """Test Place has attrbut price_by_night, and it's an int == 0"""
        place = Place()
    ...
    def test_latitude_attr(self):
        """Test Place has attrbut latitude, and it's a float == 0.0"""
        place = Place()
    ...
    def test_longitude_attr(self):
        """Test Place has attrbut longitude, and it's a float == 0.0"""
        place = Place()
    ...
    def test_amenity_ids_attr(self):
        """Test Place has attrbut amenity_ids, and it's an empty list"""
        place = Place()
